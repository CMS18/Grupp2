...
namespace Uppgift2
{
    class Sudoku2
    {
        ...
        private const string zen = "00000000000000000000000000000000000000001000000000000000000000000000000000000000";
...
<<<<<<< HEAD
            Sudoku game = new Sudoku(diabolic2, debug);
=======
            Sudoku game = new Sudoku(unsolvable1, debug);
>>>>>>> e11b88c0baafa1f718424005bdd228e8b5ecb14c
            game.Solve();
        }
    }
}
